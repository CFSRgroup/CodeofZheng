function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY] = elm_kernel_m(XTR, YTR, YTE, XTE, Elm_Type, Regularization_coefficient, Kernel_type, Kernel_para)
...
Omega_train=double(Omega_train);
