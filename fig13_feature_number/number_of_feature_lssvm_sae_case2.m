...
nn = nntrain(nn, xtr_3(:,1:j), ytr_3, opts);
labels = nnpredict(nn, xte_3(:,1:j));
yte_p_1=labels;
...
opts.numepochs =   20;
opts.batchsize = 25;
nn = nntrain(nn, xtr_4(:,1:j), ytr_4, opts);
labels = nnpredict(nn, xte_4(:,1:j));
yte_p_1=labels;
...
save F:\matlab\trial_procedure\study_1\fig13_feature_number\subject6_case2_1 acc_lssvm_case2 acc_sae_case2