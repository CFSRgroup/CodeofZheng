...
% yte_p=predict(nb,xte);
% accuracy=length(find(yte_p==yte))/length(yte);%精确度判断
% post=posterior(nb,xte);%表示某个样本点属于某个类型的概率,2700*3，哪个概率大属于哪个类别
% 
...
% 
% % save F:\matlab\trial_procedure\study_1\baseline_performance\nb_cross_subject\task1_session1_A per_index accuracy
% save F:\matlab\trial_procedure\study_1\baseline_performance\nb_cross_subject\task1_session2_A per_index accuracy
...
% 
% 
% % save F:\matlab\trial_procedure\study_1\baseline_performance\nb_cross_subject\task2_session1_N per_index accuracy
% save F:\matlab\trial_procedure\study_1\baseline_performance\nb_cross_subject\task2_session2_N per_index accuracy
% 
% plot(yte);
...
save F:\matlab\trial_procedure\study_1\data_analysis\lpp_nb_cross_subject\task1_session1 per_index_single1 per_index_ave1 accuracy1 time1 subject_average_accuracy1
...
save F:\matlab\trial_procedure\study_1\data_analysis\lpp_nb_cross_subject\task1_session2 per_index_single2 per_index_ave2 accuracy2 time2 subject_average_accuracy2
...
save F:\matlab\trial_procedure\study_1\data_analysis\lpp_nb_cross_subject\task2_session1 per_index_single3 per_index_ave3 accuracy3 time3 subject_average_accuracy3
...
save F:\matlab\trial_procedure\study_1\data_analysis\lpp_nb_cross_subject\task2_session2 per_index_single4 per_index_ave4 accuracy4 time4 subject_average_accuracy4
