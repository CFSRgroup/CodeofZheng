...
xtr_1= mapminmax(xtr_1, 0, 1); 
xte_1= mapminmax(xte_1, 0, 1);
...
opts.momentum  =   0;
opts.alpha     =   1;
dbn = dbnsetup(dbn, xtr_1, opts);
dbn = dbntrain(dbn, xtr_1, opts);
...
save F:\matlab\trial_procedure\study_1\data_analysis\dbn_cross_subject\task1_session1 per_index_single1 per_index_ave1 accuracy1 time1 subject_average_accuracy1
...
xtr_2= mapminmax(xtr_2, 0, 1); 
xte_2= mapminmax(xte_2, 0, 1);
...
opts.momentum  =   0;
opts.alpha     =   1;
dbn = dbnsetup(dbn, xtr_2, opts);
dbn = dbntrain(dbn, xtr_2, opts);
...
save F:\matlab\trial_procedure\study_1\data_analysis\dbn_cross_subject\task1_session2 per_index_single2 per_index_ave2 accuracy2 time2 subject_average_accuracy2
...
xtr_3= mapminmax(xtr_3, 0, 1); 
xte_3= mapminmax(xte_3, 0, 1);
...
opts.momentum  =   0;
opts.alpha     =   1;
dbn = dbnsetup(dbn, xtr_3, opts);
dbn = dbntrain(dbn, xtr_3, opts);
...
save F:\matlab\trial_procedure\study_1\data_analysis\dbn_cross_subject\task2_session1 per_index_single3 per_index_ave3 accuracy3 time3 subject_average_accuracy3
...
xtr_4= mapminmax(xtr_4, 0, 1); 
xte_4= mapminmax(xte_4, 0, 1);
...
opts.momentum  =   0;
opts.alpha     =   1;
dbn = dbnsetup(dbn, xtr_4, opts);
dbn = dbntrain(dbn, xtr_4, opts);
...
save F:\matlab\trial_procedure\study_1\data_analysis\dbn_cross_subject\task2_session2 per_index_single4 per_index_ave4 accuracy4 time4 subject_average_accuracy4
