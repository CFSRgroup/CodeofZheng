...
% yte=y1;
% 
% yte_p=knnclassify(xte,xtr,ytr,40);
% %     
...
% 
% % save F:\matlab\trial_procedure\study_1\baseline_performance\knn_cross_subject\task1_session1_H per_index 
% save F:\matlab\trial_procedure\study_1\baseline_performance\knn_cross_subject\task1_session2_H per_index 
...
% 
% 
% % save F:\matlab\trial_procedure\study_1\baseline_performance\knn_cross_subject\task2_session1_N per_index 
% save F:\matlab\trial_procedure\study_1\baseline_performance\knn_cross_subject\task2_session2_N per_index 
% 
% plot(yte);
...
%训练精度
predict_train=knnclassify(xtr_1,xtr_1,ytr_1,39);
...
% yte_p(1+(i-1)*2700:2700+(i-1)*2700,1)=predict(mdl,xte_1);
yte_p=predict(mdl,xte_1);
end_time_test=cputime;
TestingTime(i,j)=end_time_test-start_time_test; 

% yte_p_label=yte_p;
% save F:\matlab\trial_procedure\study_1\roc_data\knn_cross_subject\task1_session1 yte_p_label y
%测试精度
TestingAccuracy(i,j)=length(find(yte_p==yte_1))/length(yte_1);

   
   %测试时间
%    start_time_test=cputime;
%    yte_p=knnclassify(xte_1,xtr_1,ytr_1,j);
%    end_time_test=cputime;
%    TestingTime(i,j)=end_time_test-start_time_test; 
...
% % save F:\matlab\trial_procedure\study_1\performance_comparison\knn_cross_subject\task1_session1 per_index accuracy time plot_TrainingAccuracy plot_TestingAccuracy
% save F:\matlab\trial_procedure\study_1\data_analysis\knn_cross_subject\task1_session1 per_index_single1 per_index_ave1 accuracy1 time1 subject_average_accuracy1
save F:\matlab\trial_procedure\study_1\data_analysis\lpp_knn_cross_subject\task1_session1 per_index_single1 per_index_ave1 accuracy1 time1 subject_average_accuracy1
...
% title('(g) KNN: Case 1','FontWeight','bold');
...
for i=1:K
   ...
   rand('state',0)  %resets the generator to its initial state
%训练精度
predict_train=knnclassify(xtr_2,xtr_2,ytr_2,39);
...
%测试时间
start_time_test=cputime;
% yte_p(1+(i-1)*2700:2700+(i-1)*2700,1)=predict(mdl,xte_2);
yte_p=predict(mdl,xte_2);
end_time_test=cputime;
TestingTime(i,j)=end_time_test-start_time_test; 

% yte_p_label=yte_p;
% save F:\matlab\trial_procedure\study_1\roc_data\knn_cross_subject\task1_session2 yte_p_label y
%测试精度
TestingAccuracy(i,j)=length(find(yte_p==yte_2))/length(yte_2);
...
% % save F:\matlab\trial_procedure\study_1\performance_comparison\knn_cross_subject\task1_session2 per_index accuracy time plot_TrainingAccuracy plot_TestingAccuracy
% save F:\matlab\trial_procedure\study_1\data_analysis\knn_cross_subject\task1_session2 per_index_single2 per_index_ave2 accuracy2 time2 subject_average_accuracy2
save F:\matlab\trial_procedure\study_1\data_analysis\lpp_knn_cross_subject\task1_session2 per_index_single2 per_index_ave2 accuracy2 time2 subject_average_accuracy2
...
for i=1:K
   ...
   rand('state',0)  %resets the generator to its initial state
%训练精度
predict_train_1=knnclassify(xtr_3,xtr_3,ytr_3,50);
...
% yte_p_1(1+(i-1)*1450:1450+(i-1)*1450,1)=predict(mdl_1,xte_3);
...
% save F:\matlab\trial_procedure\study_1\roc_data\knn_cross_subject\task2_session1 yte_p_label_1 y_1
%测试精度
TestingAccuracy_1(i,j)=length(find(yte_p_1==yte_3))/length(yte_3);
...
% 
% % save F:\matlab\trial_procedure\study_1\performance_comparison\knn_cross_subject\task2_session1 per_index_1 accuracy_1 time_1 plot_TrainingAccuracy_1 plot_TestingAccuracy_1
% save F:\matlab\trial_procedure\study_1\data_analysis\knn_cross_subject\task2_session1 per_index_single3 per_index_ave3 accuracy3 time3 subject_average_accuracy3
save F:\matlab\trial_procedure\study_1\data_analysis\lpp_knn_cross_subject\task2_session1 per_index_single3 per_index_ave3 accuracy3 time3 subject_average_accuracy3
...
% title('(h) KNN: Case 2','FontWeight','bold');
% set(gca,'XTick',0:10:50);
% set(gca,'XTickLabel',{'0','10','20','30','40','50'});
% set(gca,'YTick',0:0.05:1);
% xlabel('Parameter k','FontWeight','bold');
...
for i=1:K
    ...
    rand('state',0)  %resets the generator to its initial state
%训练精度
predict_train_1=knnclassify(xtr_4,xtr_4,ytr_4,50);
...
%测试时间
start_time_test_1=cputime;
% yte_p_1(1+(i-1)*1450:1450+(i-1)*1450,1)=predict(mdl_1,xte_4);
yte_p_1=predict(mdl_1,xte_4);
end_time_test_1=cputime;
TestingTime_1(i,j)=end_time_test_1-start_time_test_1; 

% yte_p_label_1=yte_p_1;
% save F:\matlab\trial_procedure\study_1\roc_data\knn_cross_subject\task2_session2 yte_p_label_1 y_1
% %测试精度
% TestingAccuracy_1(i,j)=length(find(yte_p_1==yte_4))/length(yte_4);
%     
...
% % save F:\matlab\trial_procedure\study_1\performance_comparison\knn_cross_subject\task2_session2 per_index_1 accuracy_1 time_1 plot_TrainingAccuracy_1 plot_TestingAccuracy_1
% save F:\matlab\trial_procedure\study_1\data_analysis\knn_cross_subject\task2_session2 per_index_single4 per_index_ave4 accuracy4 time4 subject_average_accuracy4
save F:\matlab\trial_procedure\study_1\data_analysis\lpp_knn_cross_subject\task2_session2 per_index_single4 per_index_ave4 accuracy4 time4 subject_average_accuracy4
