...
[~,TrainingAccuracy(i,j),elm_model,label_index_expected] = elm_train_m(xtr_1,ytr_1, 1, 390, 'sig', 2^0);%ELM只认1，2类标签，不认0，1
...
[~,TrainingAccuracy(i,j),elm_model,label_index_expected] = elm_train_m(xtr_2,ytr_2, 1, 390, 'sig', 2^0);%ELM只认1，2类标签，不认0，1
end_time_train=cputime;
TrainingTime(i,j)=end_time_train-start_time_train;
...
[~,TrainingAccuracy_1(i,j),elm_model_1,label_index_expected_1] = elm_train_m(xtr_3,ytr_3, 1, 60, 'sig', 2^0);%ELM只认1，2类标签，不认0，1
...
[~,TrainingAccuracy_1(i,j),elm_model_1,label_index_expected_1] = elm_train_m(xtr_4,ytr_4, 1, 60, 'sig', 2^0);%ELM只认1，2类标签，不认0，1
end_time_train_1=cputime;
TrainingTime_1(i,j)=end_time_train_1-start_time_train_1;
